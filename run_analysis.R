...
xTrainingDf <- read.csv("train/X_train.txt", sep = "", header = FALSE)
yTrainingDf <- read.csv("train/y_train.txt", sep = "", header = FALSE)
yTestDf <- read.csv("test/y_test.txt",sep = "", header = FALSE)
xTestDf <- read.csv("test/X_test.txt", sep = "", header = FALSE)
subjectTestDf <- read.csv("test/subject_test.txt", sep = "", header = FALSE)
subjectTrainDf <- read.csv("train/subject_train.txt", sep = "", header = FALSE)
...
yTrainingDf <- rename(yTrainingDf, c("V1" = "ActivityName"))
